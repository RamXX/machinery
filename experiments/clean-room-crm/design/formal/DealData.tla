...
None == "none"
Rank == [Prospecting |-> 0, Qualification |-> 1, Proposal |-> 2, Negotiation |-> 3, Won |-> 4, Lost |-> 4]
NextStage == [Prospecting |-> "Qualification", Qualification |-> "Proposal", Proposal |-> "Negotiation"]
...
Init ==
  /\ st = "Prospecting" /\ stage = "Prospecting"
  /\ rc = 0 /\ pending = None /\ prior = None /\ closeSet = FALSE

StartAdvance ==
  /\ st \in {"Prospecting", "Qualification", "Proposal"}
