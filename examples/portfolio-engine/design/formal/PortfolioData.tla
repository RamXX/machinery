...
\* GENERATED by tools/refine_gen.py from Portfolio.machine.json + Portfolio.semantics.yaml.
...
\* perform, the retry bound MaxRetries = 3, and single-instance execution.
EXTENDS Naturals
