---- MODULE PaymentsContract ----
EXTENDS Naturals

\* Generated from PaymentsContract.machine.json by machinery tla. Control-flow model.
\*
...
States == {"Done", "Settling"}
Domain == {"Done", "Settling"}
Overlay == {}
Final == {"Done"}
...
Init == st = "Settling"
  ...
  \* T1: Settling -on:capture-> Done
  \* T2: Settling -on:decline-> Done

T1 == st = "Settling" /\ st' = "Done"
T2 == st = "Settling" /\ st' = "Done"
