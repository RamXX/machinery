...
|---|---|---|---|---|
| `openDatabase` | actor | `(input{dbPath}) -> Tx \| err{ErrLocked,ErrCorrupt,ErrUnavailable}` | post: DB open for writing, or typed error | C4 `crm.commands -> crm.repo` then `crm.repo -> store` (Repo.Connect) |
