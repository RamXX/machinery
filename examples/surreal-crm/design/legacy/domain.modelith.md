...
| Value | Definition |
| --- | --- |
| `Call` | A phone call recorded by the legacy LadybugDB-backed release. |
...
| Value | Definition |
| --- | --- |
| `Lead` | Unqualified opportunity in the legacy LadybugDB-backed release. |
...
| Value | Definition |
| --- | --- |
| `Open` | Created, not started, in the legacy LadybugDB-backed release. |
...
| Value | Definition |
| --- | --- |
| `Admin` | Unrestricted access in the legacy LadybugDB-backed release. |
...
| Value | Definition |
| --- | --- |
| `Active` | May authenticate and act in the legacy LadybugDB-backed release. |
...
| --- | --- | --- |
| `name` | string | Legacy LadybugDB account display name. |
| `domain` | string |  |
| `industry` | string |  |
...
| Name | Type | Description |
| --- | --- | --- |
| `type` | ActivityType | Legacy LadybugDB activity classification. |
| `subject` | string |  |
| `body` | string |  |
...
| Name | Type | Description |
| --- | --- | --- |
| `fullName` | string | Legacy LadybugDB contact display name. |
| `email` | string |  |
| `phone` | string |  |
| `title` | string | Legacy LadybugDB contact job title. |
...
| Name | Type | Description |
| --- | --- | --- |
| `title` | string | Legacy LadybugDB deal title. |
| `amountCents` | integer |  |
| `stage` | DealStage |  |
| `closeDate` | timestamp |  |
...
| Name | Type | Description |
| --- | --- | --- |
| `name` | string | Legacy LadybugDB pipeline display name. |
| `isDefault` | boolean |  |
...
| Name | Type | Description |
| --- | --- | --- |
| `name` | string | Legacy LadybugDB tag display name. |
| `color` | string |  |
...
| Name | Type | Description |
| --- | --- | --- |
| `title` | string | Legacy LadybugDB task title. |
| `dueDate` | timestamp |  |
| `status` | TaskStatus |  |
...
| Name | Type | Description |
| --- | --- | --- |
| `name` | string | Legacy LadybugDB team display name. |
...
| Name | Type | Description |
| --- | --- | --- |
| `username` | string | Legacy LadybugDB user login name. |
| `passwordHash` | string |  |
| `role` | UserRole |  |
| `status` | UserStatus |  |
| `createdAt` | timestamp |  |
