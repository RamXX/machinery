...
// VersionSkewNote returns the single non-blocking INFO line `machinery check`
// prints when any checked committed artifact was generated by a machinery
// version other than the running one; "" when there is no skew. A missing
// stamp is a pre-stamp artifact, never skew.
func VersionSkewNote(gs []*Gate) string {
	...
	sort.Strings(vs)
	return "note: artifacts generated by machinery " + strings.Join(vs, ", ") +
