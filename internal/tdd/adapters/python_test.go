...
func TestPythonReconciliationViolationMatrix(t *testing.T) {
	...
	cases := []struct {
		...
		{"duplicate witness", strings.Replace(pySampleReport, `{"assertion": "unit/beta", "condition": false, "kind": "witness", "schema": "machinery.tdd.witness/v1", "site": "unit_test.py:9", "test": "unit_test.UnitTests.test_fail", "thrown": "AssertionError"}`+"\n", `{"assertion": "unit/beta", "condition": false, "kind": "witness", "schema": "machinery.tdd.witness/v1", "site": "unit_test.py:9", "test": "unit_test.UnitTests.test_fail", "thrown": "AssertionError"}`+"\n"+`{"assertion": "unit/beta", "condition": false, "kind": "witness", "schema": "machinery.tdd.witness/v1", "site": "unit_test.py:9", "test": "unit_test.UnitTests.test_fail", "thrown": "AssertionError"}`+"\n", 1), "ASSERTION_MISMATCH"},
