...
func generatedReason(design, rel string) string {
	...
	case strings.HasPrefix(sub, "formal/") && strings.HasSuffix(base, ".oracle.md"):
		return rel + " is generated by 'machinery alloy' from the domain model + " +
			"formal/policy.relational.yaml. Edit those sources, run 'machinery alloy " + design + "', " +
	...
	case strings.HasPrefix(sub, "formal/") && strings.HasSuffix(base, ".als"):
		return rel + " is generated by 'machinery alloy' from the domain model + " +
			"formal/policy.relational.yaml. Edit those sources, run 'machinery alloy " + design + "', " +
