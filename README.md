...
| ERROR / DRIFT / WARN / SHADOW | ERROR is blocking; DRIFT means a generated artifact is stale, also blocking; WARN is advisory; SHADOW is a Gy-rules finding in shadow mode, printed and counted but neither blocking nor a warning (not even under `--warnings-as-errors`). |
