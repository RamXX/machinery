...
|---|---|---|---|---|---|---|
| T-ORDE-01 | ORDE-eb2d3b | Pending | on:confirm | guardCanConfirm | persisting | resetRetries, setPendingConfirmed |
| T-ORDE-02 | ORDE-0e3d1c | Pending | on:confirm | - | (internal) | recordConfirmDenied |
| T-ORDE-03 | ORDE-105d03 | Pending | on:cancel | guardCanCancel | persisting | resetRetries, setPendingCancelled |
| T-ORDE-04 | ORDE-1ded14 | Pending | on:cancel | - | (internal) | recordCancelDenied |
| T-ORDE-05 | ORDE-3c919f | Confirmed | on:markReserved | - | persisting | resetRetries, setPendingReserved |
| T-ORDE-06 | ORDE-45acde | Confirmed | on:cancel | guardCanCancel | persisting | resetRetries, setPendingCancelled |
| T-ORDE-07 | ORDE-f66b57 | Confirmed | on:cancel | - | (internal) | recordCancelDenied |
| T-ORDE-08 | ORDE-df0887 | Confirmed | on:fail | - | persisting | resetRetries, setPendingFailed |
| T-ORDE-09 | ORDE-fb2298 | Reserved | on:markPaid | - | persisting | resetRetries, setPendingPaid |
| T-ORDE-10 | ORDE-d86830 | Reserved | on:fail | - | persisting | resetRetries, setPendingFailed |
| T-ORDE-11 | ORDE-cce1ac | Paid | on:markShipped | - | persisting | resetRetries, setPendingShipped |
| T-ORDE-12 | ORDE-c08239 | Paid | on:fail | - | persisting | resetRetries, setPendingFailed |
| T-ORDE-13 | ORDE-45dbe0 | Shipped | on:markDelivered | - | persisting | resetRetries, setPendingDelivered |
| T-ORDE-14 | ORDE-22f51c | Shipped | on:fail | - | persisting | resetRetries, setPendingFailed |
...
| T-ORDE-34 | ORDE-68f4ee | rolledBack | always | - | routingFault | recordRoutingError |

Total transitions (test cases): 34
