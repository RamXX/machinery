...
func newCheckCmd() *cobra.Command {
	c := &cobra.Command{
		Use:   "check <design-dir> [--impl d] [--commit sha] [--gate gm,gs,gp,gi,gn,gc,g2,g3,gd,gx,gk,gb,ge,ga,g4,gt,g5]",
	...
	c.Flags().StringVar(&gateList, "gate", "", "comma list of gates to run: gm,gs,gp,gi,gn,gc,g2,g3,gd,gx,gk,gb,ge,ga,g4,gt,g5")
